...
Official `godoc` documentation (with examples) can be found at the [Package Registry](https://pkg.go.dev/authentication-service/internal/testing).
...
```bash
go get -u authentication-service/internal/testing
```
...
- See https://pkg.go.dev/authentication-service/internal/testing for additional documentation.
