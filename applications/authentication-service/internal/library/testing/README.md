...
Official `godoc` documentation (with examples) can be found at the [Package Registry](https://pkg.go.dev/authentication-service/internal/library/go-kubernetes-testing).
...
```bash
go get -u authentication-service/internal/library/go-kubernetes-testing
```
...
- See https://pkg.go.dev/authentication-service/internal/library/go-kubernetes-testing for additional documentation.
