...
func Setup(ctx context.Context, service, version string) (shutdown func(context.Context) error, err error) {
	...
	tracerProvider, err := traces(ctx, service, version)
	if err != nil {
		handleErr(err)
		return
	}
...
func traces(ctx context.Context, service, version string) (*trace.TracerProvider, error) {
...
func metrics(ctx context.Context) (*metric.MeterProvider, error) {
...
func logger(ctx context.Context) (*log.LoggerProvider, error) {
